...
WEIGHTS = {
    ...
    'AM_Collision_Free': 19.14,
    'allowed_AM_Collision_Free': 0.002,

    'SM_Collision_Free': 4.826,
    'SM_Below_AABB': 100.0,

    'operation_volume': 2.5,
    'allowed_operation_volume': 0.25,
...
BAYESIAN_WEIGHT_SEARCH_SPACE = {
    'final_state':              (0.1, 10.0, True),
    'self_support':             (1.0, 100.0, False),
    'AM_Collision_Free':        (1.0, 50.0, False),
    'SM_Collision_Free':        (0.1, 100.0, True),
    'operation_volume':         (0.1, 50.0, True),
    'structure':                (0.001, 10.0, True),
}

BAYESIAN_METRIC_TARGETS = {
    'final_state_accuracy':      (0.99, 'higher'),   # 98% of empty points correctly classified
    'self_support_ratio':        (0.95, 'higher'),   # 95% of AM points have support
    ...
    'structure_normalized':      (0.001, 'lower'),  # per-grid structure penalty threshold
}
...
MANU_CONFIG = {
    ...
    'min_layer_AM': 0.6/SCALE,
    'max_layer_AM': 1.4/SCALE,
