...
BAYESIAN_WEIGHT_SEARCH_SPACE = {
    'final_state':              (0.05, 5.0, True),
    'self_support':             (1.0, 80.0, False),
    'AM_Collision_Free':        (1.0, 100.0, False),
    'SM_Collision_Free':        (0.1, 5.0, False),
    'operation_volume':         (0.1, 10.0, True),
    'structure':                (0.005, 0.5, True),
}

BAYESIAN_LOSS_THRESHOLDS = {
    'final_state':         0.065,
    'self_support_avg':    0.008,
    'AM_Collision_Free':   0.004,
    'SM_Collision_Free':   0.17,
    'operation_volume':    0.7,
    'structure':           75.0,
}
...
MANU_CONFIG = {
    ...
    'min_layer_AM': 0.2/SCALE,
    'max_layer_AM': 0.8/SCALE,
    ...
    'min_layer_SM': 0.1/SCALE,
    'max_layer_SM': 0.5/SCALE,
