...
WEIGHTS = {
    ...
    'self_support': 12.72,
    # 12.72
    'allowed_self_support': 0.0052,

    'AM_Collision_Free': 90.0,
    # 89.69
    'allowed_AM_Collision_Free': 0.001,

    'SM_Collision_Free': 20.0,
    # 1.341
    'SM_Below_AABB': 100.0,

    'operation_volume': 20.0,
    # 3.217
    'allowed_operation_volume': 0.16,
    
    'structure': 5.0,
    # 0.9358
    'allowed_structure': 0.0025,
    'structure_simp_penalty': 0.0001,
}

BAYESIAN_WEIGHT_SEARCH_SPACE = {
    'final_state':              (0.01, 10.0, True),
    'self_support':             (1.0, 100.0, False),
    'AM_Collision_Free':        (1.0, 100.0, False),
    'SM_Collision_Free':        (1.0, 150.0, False),
    'operation_volume':         (0.1, 20.0, True),
    'structure':                (0.1, 100.0, True),
}

BAYESIAN_METRIC_TARGETS = {
    'final_state_accuracy':      (0.98, 'higher'),   # 98% of empty points correctly classified
    'self_support_ratio':        (0.98, 'higher'),   # 95% of AM points have support
    'AM_collision_free_ratio':   (0.99, 'higher'),   # 99% of AM points collision-free
    'SM_collision_free_ratio':   (0.95, 'higher'),   # 95% of SM points collision-free
