...
WEIGHTS = {
    ...
    'AM_Collision_Free': 70.38,
    'allowed_AM_Collision_Free': 0.0005,

    'SM_Collision_Free': 3.232,
    'SM_Below_AABB': 100.0,
...
BAYESIAN_WEIGHT_SEARCH_SPACE = {
    ...
    'AM_Collision_Free':        (1.0, 80.0, False),
...
BAYESIAN_METRIC_TARGETS = {
    ...
    'structure_normalized':      (7e-6, 'lower'),  # per-grid structure penalty threshold
}
